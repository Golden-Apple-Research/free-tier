    ...
    plugins: [
      ...
      // Rewriting wie im Build, damit tlh-Seiten auch in dev mit Font/Bild rendern.
      {
        ...
        transform(code, id) {
          ...
          const prefixed = base === '/' ? code : code.replaceAll("url('/", `url('${base}`);
      ...
      sidebar: [
        {
          ...
          items: [
            { slug: 'index', label: 'Überblick', translations: { en: 'Overview', tlh: 'nobmey' } },
            { slug: 'helpers', label: 'Skills & MCP-Server', translations: { en: 'Skills & MCP Servers', tlh: 'Skills & MCP-Server' } },
          ],
        },
        ...
        })),
        {
          ...
          link: 'https://github.com/Golden-Apple-Research/free-tier/examples',
